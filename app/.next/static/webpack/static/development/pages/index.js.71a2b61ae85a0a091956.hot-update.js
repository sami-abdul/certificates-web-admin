          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 7;
                return _interface_certificateController__WEBPACK_IMPORTED_MODULE_2__["default"].methods.getCertificateByStudentId(_utils_constants__WEBPACK_IMPORTED_MODULE_6__["default"].convertStringToHex(_this.state.idValue)).call();
              ...
              case 7:
                ...
                if (certificate['0'].length === 0) {
                  ...
                  _this.setState({
                    searchedCertificate: certificate,
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderCertificates", function (certificates) {
      ...
      if (_this.state.idType === 'studentId') {
        for (var i = 0; i < certificates['0'].length; i++) {
          items.push({
            header: _utils_constants__WEBPACK_IMPORTED_MODULE_6__["default"].convertHexToString(certificates['2'][i]),
            description: react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_routes__WEBPACK_IMPORTED_MODULE_4__["Link"], {
        ...
        items.push({
          header: _utils_constants__WEBPACK_IMPORTED_MODULE_6__["default"].convertHexToString(certificates['2']),
          description: react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_routes__WEBPACK_IMPORTED_MODULE_4__["Link"], {
            route: "/certificate/".concat(_this.state.idValue)
          }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("a", null, "View Certificate")),
          fluid: true
        });
      }
  ...
  _createClass(StudentCertificateIndex, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_5__["default"], null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_3__["Form"], {
        ...
        action: true
      }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("input", null), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_3__["Select"], {
        compact: true,
        options: options,
        ...
        type: "submit"
      }, "Search"))), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_routes__WEBPACK_IMPORTED_MODULE_4__["Link"], {
      ...
      }, this.state.errorMessage ? react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_3__["Message"], {
        error: true,
        header: "Oops!",
        content: this.state.errorMessage
      }) : null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("a", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_3__["Button"], {
        floated: "right",
      ...
      }, this.state.isCertificateFetched ? this.renderCertificates(this.state.searchedCertificate) : null), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
        style: {
          marginTop: '250px'
        }
      }, !this.state.isCertificateFetched ? react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_3__["Header"], {
        as: "h1",
        size: "massive",
        textAlign: "center",
        fluid: true,
        disabled: true
      }, "No certificates to show. ", react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("br", null), "Please use search.") : null));
    }
  }]);
...
//# sourceMappingURL=index.js.71a2b61ae85a0a091956.hot-update.js.map